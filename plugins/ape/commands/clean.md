...
argument-hint: [--all to also wipe fingerprint, candidates, and reports]
...
4. On confirmation,  delete `repos/` ONLY. Keep `fingerprint.md`, `candidates.md`, `reports/`, and `RECOMMENDATIONS.md` — they are cheap, and they make re-synthesis and future runs cheaper.
